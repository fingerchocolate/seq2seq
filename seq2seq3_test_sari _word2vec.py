...
#    parser.add_argument('--validation-interval', type=int, default=4000,
    ...
    parser.add_argument('--output', default='text_and_bleu_2.txt',
...
#            print('# expect : ' + target_sentence)###
            ...
            sari_sentence = SARIsent(list_source_sentence, list_target_sentence, list_result_sentence)#
            SARIs.append(sari_sentence)

        sari_average = statistics.mean(SARIs)
        with open(path_w, mode = 'a') as f:
            f.write('\n sari_average : %f' %sari_average)
#    @chainer.training.make_extension()
